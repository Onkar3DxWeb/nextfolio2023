...
export default function Project({ projectData: { id, mockupAllDevices, title, summary, techStack, demoLink, codeLink } }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-y-6 min-w-full px-10 sm:gap-y-10 sm:px-36 md:px-[10rem] lg:gap-y-14 lg:px-[11rem] xl:flex-row xl:gap-y-0 xl:gap-x-14 xl:px-36 2xl:gap-x-24 2xl:px-56 3xl:gap-x-32 3xl:px-[28rem] dpr-lg:gap-x-14 dpr-xl:gap-x-8" style={{background:"#fff"}}>
      {/* Project Image */}
