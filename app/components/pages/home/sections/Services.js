...
import graduatedDeveloperImage from "@/public/service.png";
    ...
    <section id="services" ref={sectionRef} className="home-section invisible flex flex-col justify-center items-center gap-y-4 min-h-[calc(100dvh_-_80px)] px-6 py-12 xs:min-h-0 xs:h-[calc(100dvh_-_80px)] xs:py-0 sm:gap-y-12 sm:px-12 md:px-16 lg:gap-y-24 lg:h-[calc(100dvh_-_86px)] lg:px-20 xl:flex-row xl:gap-y-0 xl:pr-0 xl:pl-36 2xl:pl-56 2xl:gap-x-12 3xl:pl-[28rem] 3xl:gap-x-20 landscape:min-h-0 landscape:py-0">
      ...
      <div className="space-y-6 sm:space-y-8 lg:space-y-10 xl:basis-[48%] xl:pr-16 2xl:basis-[42%] 3xl:basis-[35%]">
        ...
        <div ref={subsectionsRef} className="space-y-4 [&>div]:about-subsection lg:space-y-10 xl:space-y-6 2xl:space-y-7 3xl:space-y-9">
          ...
          <div>
            <h4>UI/UX Design</h4>
            <p>My approach encompasses comprehensive brand research to deliver customised graphic services that capture your brands identity</p>
          </div>
          
          <div>
            <h4>Website Development & Maintenance</h4>
            <p>Boost your online presence with my top-tier web development skills! I create sleek, user-friendly websites that rock. From responsive design to flawless functionality, I have got your digital back.</p>
          </div>
          
          <div>
            <h4>Shopify & Wordpress Website  Development</h4>
            <p>I will help you to setup your shopify store and develop and design a Blogs and Ecommerce based wordpress websites.</p>
          </div>
