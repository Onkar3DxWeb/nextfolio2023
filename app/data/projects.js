export const projects = [
  {
    id: 0,
    mockupAllDevices: '/mockups/galaxeye/galaxeyeall.webp',
    mockups: [
    ...
    title: 'Galaxeye',
    summary: '3D website developed for a spaceTech company',
    informativeSections: [
      {
        heading: 'Features',
        points: [
    ...
    techStack: [
      ...
      { name: 'Three.js', logo: '/tech/Three.js.png', },
      { name: 'Gsap', logo: '/tech/gsap.png', },
    ],
    demoLink: 'https://galaxeye.space/',
    codeLink: 'https://github.com/rahilbinmushfiq/gameon',
  },
  {
    id: 1,
    mockupAllDevices: '/mockups/gnoo/gnooall.webp',
    mockups: [
    ...
    title: 'Gnoo Club',
    summary: 'A Website to join a wailist of Ecommerce platform',
    informativeSections: [
      {
        heading: 'Features',
        points: [
    ...
    demoLink: 'https://gnoo.club/',
    codeLink: 'https://github.com/rahilbinmushfiq/portfolio',
  },
  {
    id: 2,
    mockupAllDevices: '/mockups/td/tdall.webp',
    mockups: [
      '/mockups/portfolio/iPhone12Pro.webp',
      '/mockups/portfolio/iPadPro.webp',
      '/mockups/portfolio/iMacPro.webp',
    ...
    openGraphImage: 'https://www.dropbox.com/scl/fi/5emmjflw1saehvsjqiimj/portfolio.png?rlkey=pmopp1dt3w7rfld2qp9utfyqx&raw=1',
    title: 'Thunder Dungeon',
    summary: 'A wordpress website for a Blogs and memes',
    informativeSections: [
      {
        heading: 'Features',
        points: [
    ...
    techStack: [
      ...
      { name: 'PHP.js', logo: '/tech/PHPjs.png', },
      { name: 'Javascript', logo: '/tech/javascript.png', },
    ],
    demoLink: 'https://thunderdungeon.com/',
    codeLink: 'https://github.com/rahilbinmushfiq/portfolio',
  },
  {
    id: 3,
    mockupAllDevices: '/mockups/qiq/qiqall.webp',
    mockups: [
      '/mockups/qiq/qiq_mob.webp',
      '/mockups/qiq/qi_m.webp',
      '/mockups/portfolio/iMacPro.webp',
    ],
    openGraphImage: 'https://www.dropbox.com/scl/fi/5emmjflw1saehvsjqiimj/portfolio.png?rlkey=pmopp1dt3w7rfld2qp9utfyqx&raw=1',
    title: 'Hello QiQ',
    summary: 'Shopify store for a skin care products',
    informativeSections: [
      {
        heading: 'Features',
        points: [
    ...
    techStack: [
      { name: 'Shopify', logo: '/tech/pngegg.png', },
      { name: 'Javascript', logo: '/tech/javascript.png', },
      { name: 'HTML5', logo: '/tech/html.png', },
      { name: 'CSS', logo: '/tech/css.png', },
    ],
    demoLink: 'https://helloqiq.com/',
    codeLink: 'https://github.com/rahilbinmushfiq/portfolio',
  },
];
